...
import { BUILDING_NODES } from '../core/building-layout';
...
export const PRESET_SCENARIOS: FireScenario[] = [
  ...
  },
  {
    ...
    keyframes: [
      ...
      { timeMs: 10_000, nodeId: 'F1_A3', temperature: 35,  smokePpm: 350, flameDetected: false, occupancy: 4 },
      { timeMs: 15_000, nodeId: 'F1_A2', temperature: 28,  smokePpm: 120, flameDetected: false, occupancy: 3 },
      { timeMs: 20_000, nodeId: 'F1_A2', temperature: 30,  smokePpm: 280, flameDetected: false, occupancy: 2 },
      { timeMs: 20_000, nodeId: 'F1_H2', temperature: 27,  smokePpm: 100, flameDetected: false, occupancy: 6 },
      { timeMs: 30_000, nodeId: 'F1_H2', temperature: 30,  smokePpm: 250, flameDetected: false, occupancy: 3 },
      { timeMs: 30_000, nodeId: 'F1_H1', temperature: 28,  smokePpm: 90,  flameDetected: false, occupancy: 2 },
      { timeMs: 40_000, nodeId: 'F1_H1', temperature: 30,  smokePpm: 200, flameDetected: false, occupancy: 0 },
      { timeMs: 25_000, nodeId: 'F1_B2', temperature: 28,  smokePpm: 80,  flameDetected: false, occupancy: 2 },
      { timeMs: 40_000, nodeId: 'F1_B2', temperature: 32,  smokePpm: 220, flameDetected: false, occupancy: 0 },
    ],
  },
  {
    id: 'multi_floor',
